...
option_list <- list (
  ...
  make_option( c("--output", "-o"), default = 'mds.pdf',
               help = "Output file name [default = %default]." ),
  
  make_option( c("--save", "-S"), default = TRUE,
               help = "Whether to save or not the fit object [default = %default]." ),
  
  make_option( c("--robject", "-r"), default = 'mds.object.Rdata',
               help = "The name of the file where to save the fit object [default = %default]."),
  
  make_option( c("--title", "-t"), default = 'Metric MDS',
  ...
  make_option( c("--colour_legend_title"), default = NULL,
               help = "The title for the legend of the colour factors [default = %default]." ),
  
  make_option( c("--shape_legend_title"), default = NULL,
               help = "The title for the legend of the shape factors [default = %default]." )
...
parser <- OptionParser(
  ...
  description = "\nProvided a distance matrix, it returns a multi-dimensional scaling representation of the data."
)
...
fit <- cmdscale( distance.object, k = 2 )
colnames(fit) <- c("x_axis", "y_axis")
